<?= form_open('kriteria/edit/'.$id, array('id' => 'formKriteria')); ?>
<div class="form-group row">
    <label for="nama" class="col-form-label col-md-3">Nama</label>
    <div class="col-md-9">
        <input type="text" class="form-control" id="nama" name="nama" placeholder="Masukan Nama" value="<?= $kriteria->nama_kriteria; ?>">
    </div>
</div>
<div class="form-group row">
    <label for="bobot" class="col-form-label col-md-3">Bobot</label>
    <div class="col-md-9">
        <input type="number" class="form-control" id="bobot" name="bobot" max="0.9999" min="0.0001" step=".0001" placeholder="Masukan Nilai Bobot" value="<?= $kriteria->bobot; ?>">
    </div>
</div>
<div class="form-group row">
    ...
    <div class="col-md-9">
        <div class="row">
            <div class="col-md-6">
                <div class="radio">
                    <label for="cost">
                        <input type="radio" name="cb" value="cost" id="cost" <?php if($kriteria->cb == 'cost')echo 'checked'; ?>>
                        Cost
                    </label>
                </div>
            </div>
            <div class="col-md-6">
                <div class="radio">
                    <label for="benefit">
                        <input type="radio" name="cb" value="benefit" id="benefit" <?php if($kriteria->cb == 'benefit')echo 'checked'; ?>>
                        Benefit
                    </label>
                </div>
            </div>
