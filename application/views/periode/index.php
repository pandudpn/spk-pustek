...
<?php 
$tambahan = '';
$tambahan .= "<a href='".site_url('periode/tambah')."' style='margin-left:10px' class='btn btn-info' id='TambahGuru'><i class='mdi mdi-plus'></i> Tambah</a>";
    ...
    $(document).ready(function() {
		var dataTable = $('#tablePeriode').DataTable({
			...
			ajax:{
				...
				type: "post",
				error: function(){ 
					$("#tablePeriode").append('<tbody><tr><th colspan="6"><center>Tidak menemukan data di Server</center></th></tr></tbody>');
				}
			}
		});
	});
