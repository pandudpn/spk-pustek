<?= form_open('periode/edit/'.$id, array('id' => 'formPeriode')); ?>
<div class="form-group row">
    <label for="nama" class="col-form-label col-md-3">Nama</label>
    <div class="col-md-9">
        <input type="text" class="form-control" id="nama" name="nama" placeholder="Masukan Nama" value="<?= $periode->nama_periode; ?>">
    </div>
</div>
<?= form_close(); ?>
<div id="result"></div>
